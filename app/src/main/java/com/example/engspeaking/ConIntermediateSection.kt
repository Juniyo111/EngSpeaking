...
@Composable
fun ConIntermediateSection(navController: NavHostController) {
    ...
    Scaffold(
        ...
        Column(
            ...
            LazyRow(
                ...
                itemsIndexed(listOf(
                    "Basic" to "con_basic",
                    "Intermediate" to "con_intermediate",
                    "Advanced" to "con_advanced"
                )) { index, (title, route) ->
                    // 선택된 항목 확인
...
@Composable
fun ConIntermediateSectionPreview() {
    val navController = rememberNavController()
    ConIntermediateSection(navController = navController)
}
