...
@Composable
fun OpicNoviceSection(navController: NavHostController) {
    var selectedTabIndex by remember { mutableStateOf(0) }
    var selectedOpicLevel by remember { mutableStateOf("NOVICE")}
...
@Composable
fun OpicNoviceSectionPreview() {
    val navController = rememberNavController()
    OpicNoviceSection(navController = navController)
}
