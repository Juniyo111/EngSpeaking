...
@Composable
fun BusMeetingSection(navController: NavHostController) {
    var selectedTabIndex by remember { mutableStateOf(3) }
    var selectedProficiencyLevel by remember { mutableStateOf("회의")}
...
@Composable
fun BusMeetingSectionPreview() {
    val navController = rememberNavController()
    BusMeetingSection(navController = navController)
}
