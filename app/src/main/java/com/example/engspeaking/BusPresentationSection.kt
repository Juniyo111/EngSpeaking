...
@Composable
fun BusPresentationSection(navController: NavHostController) {
    var selectedTabIndex by remember { mutableStateOf(3) }
    var selectedProficiencyLevel by remember { mutableStateOf("발표")}
...
@Composable
fun BusPresentationSectionPreview() {
    val navController = rememberNavController()
    BusPresentationSection(navController = navController)
}
